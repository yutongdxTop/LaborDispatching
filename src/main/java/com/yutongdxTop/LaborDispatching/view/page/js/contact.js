layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'id', title: '联系方式编号', align:"center"},
            {field: 'contactDetails', title: '联系方式', align:'center'},
            {field: 'contactValue', title: '联系方式的值', minWidth:150, align:'center'},
            {title: '操作', minWidth:175, templet:'#contactBar',fixed:"right",align:"center"}
        ]]
    });
    ...
    $(".delAll_btn").click(function(){
        var checkStatus = table.checkStatus('contactTable'),
            data = checkStatus.data;
        if(data.length > 0) {

            layer.confirm('确定删除选中的信息？', {icon: 3, title: '提示信息'}, function (index, layero) {
                for (var i in data) {
                    $.post(address + "LaborDispatching/freelancer/deleteContact",{
                        id : data[i].id
                    });
                }
                setTimeout(function(){
